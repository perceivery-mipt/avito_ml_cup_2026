...
OUT_SUBMISSION = SUBMISSIONS_DIR / "submission_geometry_v1.csv"
OUT_CANDIDATES = INTERIM_DIR / "geometry_candidates_v1.parquet"
...
def main() -> None:
    ...
    print("Building geometry candidates v1...")
    ...
    candidates = pl.concat([cand_vcr, cand_vc, cand_vsid01])
    ...
    # Cross join: 94k users * 160 popular items ≈ 15M rows.
    fallback = (
        users
